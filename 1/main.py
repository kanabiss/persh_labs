...
# Можно было сделать все без функций, но они нужны, исходдя из исловия
...
# Вызываем нашу функцию по создания словаря, передаем в параметрах объект нашего файла с номерами, который мы уже открыли
phonebook = CreateDictByFile(f)

# Вызываем нашу вторую функцию для записи в файл f отсортированных по фамилии данных из словаря phonebook
